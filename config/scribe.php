...
return [
    ...
    'title' => 'TontinePro API Documentation',

    // A short description of your API. Will be included in the docs webpage, Postman collection and OpenAPI spec.
    'description' => 'Documentation complète de l\'API TontinePro — Authentification, gestion des tontines, membres et cotisations.',
    ...
    'auth' => [
        ...
        'extra_info'  => 'Obtenez votre token via <b>POST /api/auth/login</b> puis passez-le en header : <code>Authorization: Bearer {token}</code>',
    ],
